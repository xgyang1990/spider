...
public class Comments {
    ...
    private ShowOrderComment showOrderComment;
    ...
    private List<String> productSales;
    ...
    public void setShowOrderComment(ShowOrderComment showOrderComment) {
         this.showOrderComment = showOrderComment;
     }
     public ShowOrderComment getShowOrderComment() {
